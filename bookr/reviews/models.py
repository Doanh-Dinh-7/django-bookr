...
class Contributor(models.Model):
    ...
    def initialled_name(self):
        """Trả về họ và tên tắt của contributor (VD: 'Salinger, JD')."""
        initials = ''.join([name[0] for name in self.first_names.split()])  # Lấy chữ cái đầu của từng từ trong first_names
